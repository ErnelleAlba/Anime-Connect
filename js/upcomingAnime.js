  ...
  .then((data) => {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      upcomingAnimeItem.innerHTML = `
                <div id="card-poster">
                  <a href="./detail.html?id=${newAnime.mal_id}&title=${newAnime.title_english}">
                    <img src="${newAnime.images.webp.large_image_url}" alt="${newAnime.title_english}"/>
                  </a>
                </div>
                <div class="d-flex flex-column " id="card-detail">
                    <div id="card-title"><a href="./detail.html?id=${newAnime.mal_id}&title=${newAnime.title_english}">${newAnime.title_english}</a></div>
